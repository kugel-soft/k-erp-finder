...
class ApontamentoUtils {
    ...
    public static function getApontamentos($codFun) {
        $dataIni = 20170900;
        $dataFim = 20170932;
        $dc0190 = KConnectionUtils::findDC0190ById("AK");
        if ($dc0190) {
    ...
    public static function agruparApontamentos($list) {
        ...
        foreach ($list as $dm0660) {
            ...
            if (!$linhaRelatorio) {
                ...
                // Autorizante
                $dm1658 = KConnectionUtils::findDM1658ById($linhaRelatorio->NUM_OS);
                if ($dm1658) {
                    $dc0100 = KConnectionUtils::findDC0100ById($dm1658["COD_PESSOA"]);
                    if ($dc0100) {
            ...
            if (!$servico) {
                $dm0659 = KConnectionUtils::findDM0659ById($dm0660["NUM_OS"], $dm0660["NUM_SEQ"]);
                ...
                if ($dm0659) {
                    ...
                    $dc0414 = KConnectionUtils::findDC0414ById(
